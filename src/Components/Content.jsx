  ...
  return (
    <div className="flex justify-center bg-white py-8">
      <div className="flex md:justify-evenly flex-wrap">
        <div className="sm:basis-full md:basis-1/4 mb-5 justify-self-start">
          <h5 className="text-start italic text-gray-600">
          ...
          <input
            ...
            type="text"
            id="player_name"
            className="bg-gray-50 border-none w-80 p-3 mb-2 placeholder:italic max-h-96 sm:w-1/2 md:w-80 border placeholder:text-gray-900 border-gray-300 text-md rounded-lg shadow-sm focus:outline-none focus:ring-1 sm:text-sm md:text-md lg:text-lg focus:ring-gray-900 focus:border-blue-500 block dark:bg-gray-100 dark:border-gray-600 dark:placeholder-gray-500 dark:text-dark dark:focus:ring-blue-500 dark:focus:border-blue-500"
            placeholder="Lionel Messi..."
            required
          />
          {players ? (
            <div className="no-scrollbar max-h-96 w-full sm:w-1/2 md:w-80 overflow-scroll scroll-hidden display-none rounded dark:bg-white-800 bg-white px-1 ring-1 ring-slate-900/5 shadow-xl">
              {players.map((player) => {
                return (
                  <div
                    onClick={() => getPlayerData(player.idPlayer)}
                    className="w-[100%] flex m-1 cursor-pointer items-center gap-3 bg-slate-300 p-2 rounded-xl"
                  >
                    {player.strCutout ? (
                      <img
